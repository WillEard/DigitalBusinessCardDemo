...
const PaymentPage = () => {
  ...
  const isFormValid = () => {
    return Object.entries(validators).every(([field, validateFn]) =>
      validateFn(form[field])
    );
  };
  ...
  return (
    <div className="d-flex flex-column min-vh-100 payment-wrapper text-white">
      <div className="payment-overlay flex-grow-1">
        <Navbar />
        <Row className="justify-content-center">
          <Col md={8} lg={6}>
            <h2 className="mb-4 text-center mt-5 fontNormal display-4">
              Subscription
            </h2>
            <Card className="mb-5">
              <Card.Body>
                <h5 className="mb-3 fontCondensed">
                  Plan:{" "}
                  <strong className="fontCondensed">Pelago Premium</strong>
                </h5>
                <p className="fw-bold text-danger">
                  10% of all subscriptions go towards an environmental charity
                  of your choice!
                </p>
                <p className="mb-4">
                  Amount: <strong>£4.99</strong>/month
                </p>
                ...
                <Form noValidate onSubmit={onSubmit}>
                  ...
                  >
                    ...
                    >
                      ...
                      <option value="Rainforest Alliance">
                        Rainforest Alliance
                      </option>
                      <option value="Environmental Defense Fund">
