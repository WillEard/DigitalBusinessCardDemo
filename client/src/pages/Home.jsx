...
const Home = () => {
  ...
  const { userData, getUserData } = useContext(AuthContext); // Access context values
  ...
  const userDock = [
    ...
    {
      icon: <CiLogin size={18} />,
      label: "Login",
      onClick: () => navigate("/Authenticate"),
    },
    {
      icon: <GoQuestion size={18} />,
      label: "How it works",
  ...
  return (
    <div className="ocean-background ">
      <div className="fluid">
        ...
        <div
          id="dock"
          className="d-block d-md-none position-fixed bottom-0 start-0 end-0 zindex-sticky"
        >
          <Dock
