...
const AdminDashboard = () => {
  const { userData, getUserData, backendUrl } = useContext(AuthContext);
  const {
    getAllUsers,
    allUsers,
    isLoadingUsers,
  ...
  const handleDelete = async (id, username) => {
    ...
    try {
      ...
      await axios.delete(`${backendUrl}/api/admin/all-data/${username}`, {
      ...
      <div className="login-overlay flex-grow-1">
        ...
        <Container className="my-5">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
            <h1 className="mb-1 fw-semibold fontNormal">
              Admin Dashboard: Welcome back, {firstName}
            </h1>
          </div>
          ...
          {/* USERS TABLE */}
          <Row
            className="gy-4 align-items-start justify-content-center"
            id="users"
          >
            <Col xs={12}>
          ...
          {/* AUDIT LOGS */}
          <Row
            className="gy-4 align-items-start justify-content-center mt-5"
            id="audit"
          >
            <Col xs={12}>
